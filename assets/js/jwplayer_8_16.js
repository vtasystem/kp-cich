...
window.jwplayer = function (t) {
    ...
    var r = n(18), i = {}, o = Array.prototype, u = Object.prototype, a = Function.prototype, c = o.slice, s = o.concat,
        ...
        k = function (t, e, n) {
            ...
            return t
        }, C = k, x = function (t, e, n) {
            var r = [];
            return null == t ? r : d && t.map === d ? t.map(e, n) : (k(t, (function (t, i, o) {
                r.push(e.call(n, t, i, o))
            })), r)
        }, P = x, S = "Reduce of empty array with no initial value", T = function (t, e, n, r) {
    ...
    var vt = ht.Date, gt = ht.RegExp, mt = ht.Function, bt = ht.Number, yt = ht.String, jt = function (t) {
    ...
    var r = n(0), i = 1e5, o = 100001, u = 100002, a = 101e3, c = 102e3, s = 200001, l = 202e3, f = 104e3, d = 203e3,
        ...
        P = "protectedContent", S = "technicalError", T = function () {
            ...
            return t.logMessage = function (t) {
                var e = t % 1e3, n = Math.floor((t - e) / 1e3), r = t.toString();
    ...
    var r = "buffering", i = "idle", o = "complete", u = "paused", a = "playing", c = "error", s = "loading",
        ...
        Y = "ratechange", J = "mediaType", K = "volume", Z = "mute", $ = "metadataCueParsed", G = "meta", tt = "levels",
        ...
        vt = "providerFirstFrame", gt = "userAction", mt = "instreamClick", bt = "breakpoint", yt = "fullscreenchange",
    ...
    function j(t, e) {
        var n = g(t), r = Array.isArray(e) ? e : e.split(" ");
    ...
    var r = n(30), i = n(24), o = n(17), u = n(13), a = n(40), c = n(1), s = null, l = {};

    function f(t) {
        return s || (s = function (t) {
            var e = t.get("controls"), s = h(), f = function (t, e) {
                var n = t.get("playlist");
                if (Array.isArray(n) && n.length) for (var u = Object(i.f)(t.get("item"), n.length), a = Object(i.c)(Object(r.a)(n[u]), t), c = 0; c < a.length; c++) for (var s = a[c], l = t.getProviders(), f = 0; f < o.a.length; f++) {
                    var d = o.a[f];
                    if (l.providerSupports(d, s)) return d.name === e
                }
                return !1
            }(t, "html5");
            if (e && s && f) return p = n.e(7).then(function (t) {
                n(37);
                var e = n(22).default;
            ...
            return (h() ? n.e(9).then(function (t) {
                return n(37)
    ...
    var r = n(0), i = n(7), o = n(29), u = n(8), a = n(42), c = {}, s = {
        zh: "Chinese",
        nl: "Dutch",
        en: "English",
        fr: "French",
    ...
    "use strict";
    var r = n(28), i = n(5), o = n(23), u = n(0), a = n(8), c = n(36),
    ...
    var r = n(31), i = n(8), o = function (t) {
        ...
        var t = "//ssl.p.jwpcdn.com/player/v/8.16.0/";
    ...
    function d(t, e, n) {
        ...
        if (a.preload = o(e.preload, u), a.allSources = v(e, t), a.sources = g(a.allSources, i), a.sources.length) return a.file = a.sources[0].file, a.feedData = n, function (t) {
    ...
    var u = function (t) {
        if (t && t.file) {
            var e, n = Object(r.j)({}, {kind: "captions", default: !1}, t);
    ...
    var r = "8.16.0+commercial_v8-16-0.407.commercial.4c72c7e.hlsjs.28750bd.hlsjsprogressive.06278c3.jwplayer.cc874e9.dai.07e1a38.freewheel.af0c077.googima.4590b72.googimanvmp.6873d1e.headerbidding.c9c5d84.vast.cde933a.analytics.12eed63.gapro.141397a"
}, function (t, e, n) {
    "use strict";
    ...
    var c, s, l = "ontouchstart" in window, f = "PointerEvent" in window && !r.OS.android, d = !(f || l && r.OS.mobile),
        p = r.Features.passiveEvents, h = !!p && {passive: !0}, v = function (t) {
            var e, n;
    ...
    function b(t) {
        if (!t.handlers.init) {
            var e = t.el, n = t.passive, r = !!p && {passive: n}, o = function (i) {
                ...
                if (t.dragged) x(t, i.s, e); else {
                    var r = P(e), o = r.pageX, u = r.pageY, a = o - t.startX, c = u - t.startY;
                ...
                if (clearTimeout(c), t.el) if (k(t), O(t, "window"), t.dragged) t.dragged = !1, x(t, i.t, n); else if (-1 === n.type.indexOf("cancel") && e.contains(n.target)) {
                    ...
                    }(t, n, o), o ? x(t, i.n, n) : (x(t, i.sb, n), "touchend" !== n.type || p || S(n))
                }
            };
    ...
    function w(t, e, n, r, i) {
        void 0 === i && (i = h);
        var o = t.handlers[e], u = t.options[e];
    ...
    function O(t, e) {
        var n = t.el, r = t.handlers, i = t.options, o = "window" === e ? j(n) : n, u = r[e], a = i[e];
    ...
    var f = n(7), d = n(6), p = n(11), h = n(29), v = n(55), g = n(49), m = n(56);
    ...
    function o(t, e) {
        var n = e.message, o = e.code, u = function (t, e, n, r) {
            ...
            }(t.get("id"), n, t.get("localization").errors.errorCode, (o || {}).toString()), a = t.get("width"),
            c = t.get("height"), s = Object(r.e)(u);
        return Object(i.d)(s, {
    ...
    function d(t) {
        for (var e = {}, n = 0; n < t.childNodes.length; n++) {
            var o = t.childNodes[n], u = Object(r.b)(o);
    ...
    "use strict";
    var r = n(0), i = n(25), o = n(12), u = n(2), a = n(1), c = n(20), s = function (t) {
        if ("string" == typeof t) {
    ...
    "use strict";
    var r = n(0), i = n(3), o = n(4), u = n(48), a = n(29), c = n(9), s = n(1);
    e.a = function () {
    ...
    "use strict";
    var r = n(0), i = n(58), o = n(54), u = n(19), a = n(8), c = n(27), s = n(23);
    ...
    function g(t, e) {
        var n = "file:" === window.location.protocol ? "https:" : "", r = {
            ...
            jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.16.0/jwpsrv.js",
            dai: "//ssl.p.jwpcdn.com/player/plugins/dai/v/0.4.13/dai.js",
            vast: "//ssl.p.jwpcdn.com/player/plugins/vast/v/8.7.18/vast.js",
            googima: e ? "//ssl.p.jwpcdn.com/player/v/8.16.0/googimanvmp.js" : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.7.18/googima.js",
    ...
    var b = function (t, e) {
        var i, f, b, y = Object(o.b)(t, e), j = y.key || window.jwplayer && window.jwplayer.key, w = new c.b(j),
            O = w.edition();
        ...
        if (y.flashplayer = function (t) {
            ...
            var e = Object(s.a)(t.edition), n = t.related, i = !e("discovery") || n !== Object(n),
            ...
            var e = Object(r.j)({}, t.plugins), n = Object(s.a)(t.edition);
            if (n("ads")) {
                var i = Object(r.j)({}, t.advertising), o = i.client;
                if (o) {
            ...
            var n = (t.querySelector("title") || {}).textContent, r = l(t, 'meta[property="og:title"]'),
    ...
    }, y = n(10), j = n(26), w = n(3), O = n(62), k = n(24), C = n(25), x = n(1), P = n(14);
        ...
        return L(t) ? Promise.resolve() : S(t).then((function () {
            ...
            return S(e = t).then((function () {
                if (!E(e)) {
                    ...
                    var n = e.getProviders(), r = Object(k.f)(e.get("item"), t.length), i = n.choose(t[r].sources[0]),
                        o = i.provider, u = i.name;
    ...
    var N = function (t) {
        ...
        var e = t.attributes, n = e.language, r = e.base, i = e.setupConfig, o = e.intl, u = Object(P.c)(i, o, n);
    ...
    var D = function (t) {
        ...
        this.start = function (n) {
            var r = Object(j.a)(t, n), i = Promise.all([Object(y.d)(t), r, F(t), I(t, n), N(t), R(t)]),
    ...
    }(), W = n(57), U = n(52), X = n(9), Y = n(45), J = n(63), K = n(64), Z = n(35);
    n(71), n(72);
    n.d(e, "b", (function () {
        return et
    }));
    var $ = function (t) {
        this._events = {}, this.modelShim = new W.a, this.modelShim._qoeItem = new z.a, this.mediaShim = {}, this.setup = new D(this.modelShim), this.currentContainer = this.originalContainer = t, this.apiQueue = new i.a(this, ["load", "play", "pause", "seek", "stop", "playlistItem", "playlistNext", "playlistPrev", "next", "preload", "setConfig", "setCurrentAudioTrack", "setCurrentCaptions", "setCurrentQuality", "setFullscreen", "addButton", "removeButton", "castToggle", "setMute", "setVolume", "setPlaybackRate", "addCues", "setCues", "setPlaylistItem", "resize", "setCaptions", "setControls"], (function () {
            return !0
        }))
    };
    ...
    Object(r.j)($.prototype, {
        on: X.a.on, once: X.a.once, off: X.a.off, trigger: X.a.trigger, init: function (t, e) {
            ...
            return i.on("change:errorEvent", G), this.setup.start(e).then((function (t) {
                ...
                if (n.setup) {
                    n.on(w.ub, tt), t.warnings.forEach((function (t) {
                        n.trigger(w.ub, t)
                    }));
                    ...
                    var l = n._model;
                    return i.off("change:errorEvent", G), l.on("change:errorEvent", G), o.track(l), n.updatePlaylist(l.get("playlist"), l.get("feedData")).catch((function (t) {
                ...
                n.setup && function (t, e, n) {
                    Promise.resolve().then((function () {
                        var r = Object(x.A)(x.r, x.y, n), i = t._model || t.modelShim;
                        r.message = r.message || i.get("localization").errors[r.key], delete r.key;
                        var o = i.get("contextual");
                        if (!o) {
                            var u = Object(Y.a)(t, r);
                            Y.a.cloneIcon && u.querySelector(".jw-icon").appendChild(Y.a.cloneIcon("error")), et(t, u)
                        }
            ...
            this.apiQueue && this.apiQueue.destroy(), this.setup && this.setup.destroy(), this.currentContainer !== this.originalContainer && et(this, this.originalContainer), this.off(), this._events = this._model = this.modelShim = this.apiQueue = this.setup = null
    ...
    var h = n(19), v = n(15), g = n(17), m = n(13), b = {availableProviders: g.a, registerProvider: m.a}, y = n(26);
    ...
    function F(t) {
        var e = ++E, n = t.id || "player-" + e, i = new P.a, o = {}, u = A(this, t);
    ...
    L(I);
    var N = I, R = n(35), D = n(27), B = n(25), z = n(50), q = n(48), V = n(41), H = r.f.extend, Q = {};
...
//     "height": 360,
//     "key": "G1RqkbVAQ6Yhgz52p6p2dmd01ljBk4zk0PlrtWIvk3hGch9Waxqr8+WZP50=",
//     "mute": false,
//     "ph": 1,
//     "pid": "aG3IMhIy",
